...
class AllProductsSection extends Component {
  ...
  getProducts = async () => {
    ...
    const {activeOptionId, activeCategoryId, activeRatingId, searchInput} =
      this.state
    let apiUrl = `https://apis.ccbp.in/products?sort_by=${activeOptionId}&title_search=${searchInput}&category=${activeCategoryId}&rating=${activeRatingId}`
  ...
  render() {
    const {categoryOptionsList, ratingsLists} = this.state

    return (
      <div className="all-products-section">
        <FiltersGroup
          categoryOptionsList={categoryOptionsList}
          ratingsLists={ratingsLists}
